  ...
  50: [function (require, module, exports) {
    ...
    Player.prototype.initChildren = function () {
      ...
      Player.prototype.loadNewVideoInfo = function () {
        var a = this._options.vid, b = this._options.accId, c = this._options.accSecret, d = this._options.apiKey, e = this._options.stsToken, f = this._options.domainRegion, g = this._options.authInfo, h = this; if (!a) throw new Error("PrismPlayer Error: vid should not be null!"); if (!b) throw new Error("PrismPlayer Error: accessId should not be null!");
        ...
        var i = (new Date).getTime(), j = randomUUID(), k = { ClientVersion: "0.0.1", SignVersion: "0.0.1", Channel: "HTML5", ClientTS: i, VideoId: a }, l = CryptoJS.enc.Base64.stringify(CryptoJS.enc.Utf8.parse("{" + makesort(k, "=", ",") + "}"));
        l = l.replace(/\s+/g, ""), l = l.replace(/\n+/g, ""), l = l.replace(/\r+/g, "");
      ...
      Player.prototype.userPramaRequestMts = function () {
        var a = this._options.vid, b = this._options.accId, c = this._options.accSecret, d = this._options.stsToken, e = this._options.domainRegion, f = this._options.authInfo, g = this._options.playDomain, h = this, i = ((new Date).getTime(), randomUUID()), j = randomUUID(), k = ISODateString(new Date), l = "HMAC-SHA1"; if (!a) throw new Error("PrismPlayer Error: vid should not be null!");
        ...
        var m = {
          ...
          SignatureVersion: "1.0",
          SignatureNonce: j
        }, n = makeUTF8sort(m, "=", "&") + "&Signature=" + AliyunEncodeURI(makeChangeSiga(m, c)), o = "https://mts." + e + ".aliyuncs.com/?" + n;
        io.get(o, function (a) {
          UA.IS_PC;
          if (a) {
            try {
      ...
      Player.prototype.userPlayInfoAndVidRequestMts = function () {
        var a = this, b = a._options.vid, c = CryptoJS.enc.Utf8.stringify(CryptoJS.enc.Base64.parse(a._options.playauth)), d = ((new Date).getTime(), randomUUID()), e = randomUUID(), f = ISODateString(new Date), g = "HMAC-SHA1";
